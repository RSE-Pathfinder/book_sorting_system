...
class BSSCommanderNode(Node):
    ...
    def movearm_execute_callback(self, goal_handle):
        ...
        rclpy.spin_until_future_complete(self._movexyz_action_client, futurexyz, None, 1000)
        ...
        rclpy.spin_until_future_complete(self._moveypr_action_client, futureypr, None, 1000)
